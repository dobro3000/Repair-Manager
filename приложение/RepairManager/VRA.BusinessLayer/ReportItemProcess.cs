...
start, DateTime stop)
        {
            ...
            switch (period)
            {
                case "day":
                    {
                        ReportList =
                        DtoConvert.Convert(reportDao.getPurchasedPerDays(start, stop));
                        break;
                    }
                case "month":
                    {
                        ReportList =
                       DtoConvert.Convert(reportDao.getPurchasedPerMonth(start, stop));
                        break;
                    }
                case "year":
                    {
                        ReportList =
                       DtoConvert.Convert(reportDao.getPurchasedPerYear(start, stop));
                        break;
                    }
                default:
                    {
